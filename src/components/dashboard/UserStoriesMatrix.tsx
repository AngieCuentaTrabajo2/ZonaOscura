        ...
        {stories.map((story) => (
          <Card key={story.code} className="theme-surface p-md transition-all hover:-translate-y-0.5 hover:border-blue-200">
            <div className="flex items-start justify-between gap-md">
              <span className="theme-accent rounded-full bg-slate-950 px-sm py-xs text-xs font-bold text-amber-200">{story.code}</span>
              <span className="theme-accent material-symbols-outlined text-safety-blue">{story.icon}</span>
            </div>
