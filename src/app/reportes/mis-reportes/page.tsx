...
export default async function MisReportesPage() {
  ...
  return (
    <div className="flex flex-col gap-lg max-lg:-mx-[18px] max-lg:-mt-[26px] max-lg:min-h-[calc(100vh-80px)] max-lg:bg-[#0D1117] max-lg:px-[18px] max-lg:pb-md max-lg:pt-[28px] lg:gap-lg">
      <section className="relative overflow-hidden rounded-[24px] border border-slate-700/70 bg-[linear-gradient(145deg,#111827_0%,#0f172a_52%,#0D1117_100%)] p-lg text-white shadow-[0_18px_44px_rgba(2,6,23,0.35)] lg:rounded-none lg:border-0 lg:bg-transparent lg:p-0 lg:text-primary lg:shadow-none">
